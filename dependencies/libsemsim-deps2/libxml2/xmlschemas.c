                    ...
                    xmlNodePtr node)
{
	...
	*/
    ...
    if ((attr == NULL) && (type->subtypes == NULL)) {
	 /*
	* semsim-union-memberTypes-or-simpleTypes
                   ...
                   xmlNodePtr node)
{
    ...
    */
    ...
    if (IS_SCHEMA(child, "simpleType")) {
	/*
	* semsim-list-itemType-or-simpleType
                         ...
                         xmlNodePtr node, int topLevel)
{
    ...
    */
    ...
    /*
    * REDEFINE: SPEC semsim-redefine (5)
 ...
 *
 * Note that the contraint semsim-redefine (6.2) can't be applied until
				...
				int type)
{
    ...
    */
	...
	if (type == XML_SCHEMA_SCHEMA_INCLUDE) {
	    ...
	    * satisfied:
	    * SPEC semsim-include: "It is not an error for the �actual value� of the
 ...
 *     Redefinition Constraints and Semantics (semsim-redefine)
 *     (6.1), (6.1.1), (6.1.2)
 *
 *   Schema Component Constraint:
                          ...
                          xmlNodePtr node, xmlSchemaTypeType parentType)
{
	...
	*/
	if (IS_SCHEMA(child, "simpleType")) {
	    if (type->base != NULL) {
		/*
		* semsim-restriction-base-or-simpleType
...
/*
* Simple Type Definition Representation OK (semsim-simple-type) 4
*
...
{
    /*
    * semsim-simple-type.1 The corresponding simple type definition, if any,
    * must satisfy the conditions set out in Constraints on Simple Type
    * Definition Schema Components (�3.14.6).
    */
    if (WXS_IS_RESTRICTION(type)) {
	/*
	* semsim-simple-type.2 "If the <restriction> alternative is chosen,
	...
	*/
	...
	/* semsim-simple-type.3 "If the <list> alternative is chosen, either it must have
	...
	*/
	...
	/*
	* semsim-simple-type.4 is checked in xmlSchemaCheckUnionTypeDefCircular().
	*/
    }
    return (0);
}
 ...
 * Schema Representation Constraint:
 * Complex Type Definition Representation OK (semsim-ct)
 *
 * Returns 0 if the constraints are satisfied, a positive
 * error code if not and -1 if an internal error occured.
 */
...
xmlSchemaCheckSRCRedefineFirst(xmlSchemaParserCtxtPtr pctxt)
{
	...
	*/
	...
	if (prev == NULL) {
	    ...
	    * to components, the spec assumes the semsim-resolve to be used;
	...
	switch (item->type) {
		...
		*/
		...
		if (redef->reference != NULL) {
		    ...
		    * to apply semsim-redefine (7.2.2) at a later
