...
#
# This program takes one argument, the root of the libSBML semsim/sbml
...
sys.path.append('../../../semsim/bindings/swig')
sys.path.append('../../semsim/bindings/swig')
...
def main(args):
    if len(args) != 2:
        print ("Must be given one argument: the path to the libSBML semsim/sbml dir")
        sys.exit(1)
